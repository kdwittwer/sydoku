...
// dropped into src/assets/dogs/cutouts/ is picked up automatically on the
// next dev-server reload or build — no manual import list to maintain.
// (Run scripts/generate_dog_cutouts.py after adding new source photos to
// src/assets/dogs/ to produce the matching transparent-background cutout.)
